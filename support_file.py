...
def initialize_db():
    ...
    id SEQUENCE PRIMARY KEY INCREMENT 1 START 1,
...
def save_meeting_notes(author_name, author_email, meeting_date, meeting_agenda, meeting_notes):
    ...
    cur = conn.cursor()
    cur.execute(
        "INSERT INTO public.notes (unique_code, author_name, author_email, meeting_date, meeting_agenda, meeting_notes) VALUES (%s, %s, %s, %s, %s, %s)",
